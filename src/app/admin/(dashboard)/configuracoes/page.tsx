  ...
  return (
    <div>
      ...
      <form action={updateSiteConfig} style={{ maxWidth: "1400px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(440px, 1fr))", gap: "1.25rem", alignItems: "start", marginBottom: "1.5rem" }}>
          ...
          <Section title="Contato & redes sociais" subtitle="Informações que aparecem no rodapé e na página de contato do site." wide>
            <FieldGrid>
          ...
          <Section title="Conteúdo em destaque na home" subtitle="Foto e vídeos exibidos na página inicial do site." wide>
            <FieldGrid>
          ...
          <Section title="Transmissão ao vivo" subtitle="Controla a caixa AO VIVO que aparece na home durante a transmissão de sábado." wide>
